...
## 栈解法
感谢[kevin](https://leetcode-cn.com/problems/two-sum/solution/zui-chang-you-xiao-gua-hao-de-zhan-jie-fa-by-kevin/)的思路。
...
## 动态规划解法
感谢[powcai](https://leetcode-cn.com/problems/two-sum/solution/zui-chang-you-xiao-gua-hao-by-powcai/)

我们用dp[i]表示**以i结尾**的最长有效括号,注意这里是以i结尾的，不是0到i最长有效括号。
...
栈解法循序渐进，从特殊到一般，渐渐找到题目的解法。动态规划，是要明白**以i结尾**，这一点与其它动态规划有一些区别，其次就是考虑到多种情况，给出相应的解决办法。